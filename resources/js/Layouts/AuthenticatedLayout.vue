...
<template>
    <div>
        <div class="min-h-screen bg-gray-100">
            <nav
                class="border-b border-zinc-700 bg-black"
            >
                                ...
                                <Dropdown align="right" width="48">
                                    <template #trigger>
                                        <span class="inline-flex rounded-md">
                                            <button
                                                type="button"
                                                class="inline-flex items-center rounded-md border border-transparent bg-black px-3 py-2 text-sm font-medium leading-4 text-main transition duration-150 ease-in-out hover:text-white focus:outline-none"
                                            >
