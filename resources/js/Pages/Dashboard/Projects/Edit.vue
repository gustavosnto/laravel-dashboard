...
const form = useForm({
    ...
    additional_info: props.project.additional_info,
});

const submit = () => {
    form.put(`/dashboard/projects/${props.project.id}`, {
        onSuccess: () => {
            Inertia.visit('/dashboard/projects');
        },
        onError: (errors) => {
                ...
                <div class="overflow-hidden bg-white shadow-sm sm:rounded-lg">
                    <div class="p-6 text-gray-900">
                        <form @submit.prevent="submit">
                            ...
                            <div class="mt-4">
                                <button type="submit" class="bg-blue-500 text-white px-4 py-2 rounded">Atualizar Projeto</button>
                            </div>
                        </form>
                    </div>
                </div>
