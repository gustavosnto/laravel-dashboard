    ...
    <section class="space-y-6">
        ...
        <Modal :show="confirmingUserDeletion" @close="closeModal">
            <div class="p-6">
                ...
                <p class="mt-1 text-sm text-gray-600">
                    Uma vez que sua conta for excluída, todos os seus recursos e dados serão permanentemente apagados. Insira sua senha para confirmar que deseja excluir sua conta permanentemente.
                </p>
